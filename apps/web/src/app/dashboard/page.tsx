      ...
      <section className="grid gap-8 py-9 lg:grid-cols-[minmax(0,1fr)_minmax(300px,0.85fr)] lg:items-center">
        <div>
          ...
          <div
            ...
            aria-label="Types de scan"
          >
            <div className="am-panel-soft p-4">
              <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#8793ff]">
                Scan standard
              </p>
              <p className="mt-2 text-sm font-semibold text-[#e5e9f2]">
                Contrôle rapide du site
              </p>
              <p className="mt-1 text-xs leading-5 text-[#7f8a9f]">
                Pour le suivi courant, les changements et les alertes.
              </p>
            </div>
            <div className="am-panel-soft p-4">
              <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#39c7ff]">
                Audit approfondi
              </p>
              <p className="mt-2 text-sm font-semibold text-[#e5e9f2]">
                Analyse Deep d’un domaine vérifié
              </p>
              <p className="mt-1 text-xs leading-5 text-[#7f8a9f]">
                Navigation bornée et contrôles techniques plus poussés.
              </p>
            </div>
          </div>
